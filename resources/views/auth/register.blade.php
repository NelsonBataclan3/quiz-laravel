            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('gaurdian_name') ? ' has-error' : '' }}">
                            <label for="gaurdian_name" class="col-md-4 control-label">Gaurdian Name</label>

                            <div class="col-md-6">
                                <input id="gaurdian_name" type="text" class="form-control" name="gaurdian_name" value="{{ old('gaurdian_name') }}" required autofocus>

                                @if ($errors->has('gaurdian_name'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('gaurdian_name') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
